...
User u=UserDao.getRecordByUsername(username);  
%>  
	<meta charset="UTF-8">
				...
				<div class="login100-form-title" style="background-image: url(images/bg-01.jpg);">
					<span class="login100-form-title-1">
						Edit Account
                            ...
                            <form  action="edituser.jsp" method="POST" class="login100-form validate-form">
                                
                                        <div class="wrap-input100 validate-input m-b-26" >
						<span class="label-input100">Admin ?</span>
						<input class="input100" type="text" name="admin" placeholder="Enter Y/N" value="<%=u.getAdmin()%>"/>
					...
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						...
						<input class="input100" type="password" name="password" placeholder="Enter password"value="<%= u.getPassword()%>"/>
						<span class="focus-input100"></span>
					</div>
                                ...
                                <div class="container-login100-form-btn">
                                        <input value="Edit" type="submit" class="login100-form-btn"> 
                                        ...
                                        <div class="text-center p-t-136">
                                            View Users <br>
						<a class="txt2" href="viewusers.jsp">
