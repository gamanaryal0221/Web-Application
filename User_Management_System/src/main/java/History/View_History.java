...
//        //RequestDispatcher rd1 = request.getRequestDispatcher("User_History.jsp");
//        try (PrintWriter out = response.getWriter()) {
//            
//            String loginuser = request.getParameter("uname").toString();
////            boolean is_admin = jspcrud.UserDao.getUser_is_admin(username);
////            if(is_admin==true){
////                ArrayList<History> list = HistoryDAO.getAdminHistory();
////                request.setAttribute("adminHistory", list);
////                rd.forward(request, response);s
////            }
//            
//                ArrayList<History> list = HistoryDao.getUserHistory(loginuser);
