<%-- 
    Document   : entercode
    Created on : May 23, 2020, 3:47:40 PM
    Author     : Asus
--%>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="480" >
                <tr>
                    <td bgcolor="#ffffff" align="center" valign="top" style="padding: 40px 20px 20px 20px; border-radius: 4px 4px 0px 0px; color: #111111; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 48px; font-weight: 400; letter-spacing: 4px; line-height: 48px;">
                      <h1 style="font-size: 32px; font-weight: 400; margin: 0;">Enter the received code here</h1>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr>
        <td bgcolor="#f4f4f4" align="center" style="padding: 0px 10px 0px 10px;">
            <table border="0" cellpadding="0" cellspacing="0" width="480" >
              <!-- COPY -->
            <form action="ValidateEnteredCode" method='POST'> 
              <tr>
                <td bgcolor="#ffffff" align="left" style="padding: 20px 30px 40px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;" >
                    
                    <input align="center" type="text" placeholder="Enter Code" required="true" name='passwordresetcode' style="border-radius: 3px; font-size: 20px; padding: 13px 81px;text-align:center; border-radius: 2px; border: 1px solid #7c72dc; display: inline-block;" >
                  </td>
              </tr><!--
              <!-- BULLETPROOF BUTTON -->
              <tr>
