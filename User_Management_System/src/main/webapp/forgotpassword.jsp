<%-- 
    ...
    Created on : May 22, 2020, 11:14:56 PM
    Author     : Asus
--%>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        <td bgcolor="#f4f4f4" align="center" style="padding: 0px 10px 0px 10px;">
            <table border="0" cellpadding="0" cellspacing="0" width="480" >
              <!-- COPY -->
            <form action="EmailForPasswordReset" method='POST'> 
              <tr>
                <td bgcolor="#ffffff" align="left" style="padding: 20px 30px 40px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;" >
                    
                    <input align="center" type="text" placeholder="Enter your email" required="true" name='passwordresetemail' style="border-radius: 3px; font-size: 20px; padding: 13px 81px;text-align:center; border-radius: 2px; border: 1px solid #7c72dc; display: inline-block;" >
                  </td>
              </tr><!--
              <!-- BULLETPROOF BUTTON -->
              <tr>
                    ...
                    <tr>
                      <td bgcolor="#ffffff" align="center" style="padding: 20px 30px 60px 30px;">
                        <table border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                                <td align="center" style="border-radius: 3px;" bgcolor="#7c72dc"><input value="Send Code" type="submit" style="font-size: 20px; font-family: Helvetica, Arial, sans-serif; color: #7c72dc; text-decoration: none; color: #7c72dc; text-decoration: none; padding: 15px 25px; border-radius: 2px; border: 1px solid #7c72dc; display: inline-block;"></td>
            </form>                
                          </tr>
                        </table>
                      </td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="480" >
                ...
                <tr>
                  <td bgcolor="#111111" align="left" style="padding: 40px 30px 20px 30px; color: #ffffff; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;" >
                    <h2 style="font-size: 24px; font-weight: 400; margin: 0;">You remember your password?</h2>
                  </td>
                </tr>
                <!-- COPY -->
                <tr>
                  <td bgcolor="#111111" align="left" style="padding: 0px 30px 20px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;" >
                    <p style="margin: 0;">Click on the link below to jump to the Login page.</p>
                  </td>
                </tr>
                <!-- COPY -->
                <tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="480" >
              ...
              <tr>
                <td bgcolor="#f4f4f4" align="left" style="padding: 0px 30px 30px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 400; line-height: 18px;" >
                  <p style="margin: 0;">You have received a email because you requested a password reset. Now, Check your E-mail and follow the instructions.</p>
<!--                  <a href="http://litmus.com" target="_blank" style="color: #111111; font-weight: 700;">please contact us.</a>-->
                </td>
              </tr>
